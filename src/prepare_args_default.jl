...
function prepare_args_default(; population::Population, infection::Infection,
    ...
    parameters = tuple(population,
                       ...
                       preinfectious_period_to_alpha(preinfectious_period = infection.extra_arguments.preinfectious_period),
                       infectious_period_to_gamma(infectious_period = infection.infectious_period),
                       intervention,
                       vaccination)
